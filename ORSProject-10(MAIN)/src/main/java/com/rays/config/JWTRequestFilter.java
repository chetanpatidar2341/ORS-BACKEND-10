...
/*
 * Spring Security ka Filter
   Har incoming request ko intercept karta hai
   JWT token check karta hai
   User ko authenticate karta hai
   Aur user data ThreadLocal me store karta hai
   Iska main kaam = JWT based authentication
 */
@Component
